...
color_dict = {'AGF': '#ffffff', 'AaB':'#ffffff', 'Brondby':'#ffffff', 'Esbjerg':'#ffffff', 'FC Helsingør':'#ffffff', 'Hobro':'#ffffff', 'Horsens':'#ffffff', 'København':'#ffffff', 'Lyngby':'#ffffff', 'Midtjylland':'#ffffff', 'Nordsjælland':'#ffffff', 'OB':'#ffffff', 'Randers':'#ffffff', 'Silkeborg':'#ffffff', 'Sonderjyske':'#ffffff', 'Vejle':'#ffffff', 'Vendsyssel':'#ffffff', 'Vestsjælland':'#ffffff', 'Viborg':'#ffffff'}
