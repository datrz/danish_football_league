...
if all_teams_selected == 'Include all available teams':
    row16_spacer1, row16_1, row16_2, row16_3, row16_4, row16_5, row16_spacer2  = st.columns((0.5, 1, 0.75, 0.5, 0.75, 2, 0.5))
    with row16_1:
...
#    with row16_5:
        ...
        st.markdown(f'🇩🇰 **Match {return_game_id_value_team[0]}** was played at **{stadium_name}, {city[0]}, {reg[0]}** and **{attendance1} fans** watched the game on the stadium')
