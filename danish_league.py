...
label_fact_dict = {"goals scored":'goals',"halftime goals scored":'ht_goals',"shots on the goal":'shots_on',"possession ratio":'possession',"fouls":'fouls',"yellow cards received":'yellow',"red cards received":'red',"corners":'corners'}
...
def stack_home_away_dataframe(df_data):
    ...
    delta_names = ['goals','ht_goals','shots_on','possession','fouls','yellow','red','corners','points']
    ...
    column_names = ['possession','yellow','red','corners','points','delta_goals','delta_ht_goals','delta_shots_on','delta_possession','delta_fouls','delta_yellow','delta_red','delta_corners','delta_points']
    ...
    column_names_new = ['game_id','season','matchday','location','team','goals','goals_received','ht_goals','ht_goals_received','shots_on','shots_on_received','fouls','got_fouled','possession','yellow','red','corners', 'points','delta_goals','delta_ht_goals','delta_shots_on','delta_possession','delta_fouls','delta_yellow','delta_red','delta_corners','delta_points']
...
with row3_1:
    st.markdown("Welcome to the danish Superliga Streamlit dashboard!")
