...
label_attr_dict_teams = {"Goals Scored":"goals","Goals Received":"goals_received","Halftime Goals Scored":"ht_goals","Halftime Goals Received":"halftime_goals_received","Winning odds":"odds", "Pre Match Expected Goals":"pre_xg", "Post Match Expected Goals":"xg","Ball Possession":"possession", "Fouls Committed":"fouls", "Red Cards":"red", "Yellow Cards":"yellow", "Corners":"corners","Points received":"points"}
...
city_dict = {
    'Aarhus': 'Aarhus Stadium',
    'Viborg': 'Viborg Stadium',
    'Odense': 'Odense Stadium',
    'Brondby Kommune': 'Brondby Kommune Stadium',
    'Aalborg': 'Aalborg Stadium',
    'Esbjerg': 'Esbjerg Stadium',
    'Farum': 'Farum Stadium',
    'Slagelse': 'Slagelse Stadium',
    'Randers': 'Randers Stadium',
    'Haderslev': 'Haderslev Stadium',
    'Herning': 'Herning Stadium',
    'Kobenhavn': 'Kobenhavn Stadium',
    'Silkeborg': 'Silkeborg Stadium',
    'Hobro': 'Hobro Stadium',
    'Horsens': 'Horsens Stadium',
    'Kongens Lyngby': 'Kongens Lyngby Stadium',
    'Helsingor': 'Helsingor Stadium',
    'Vejle': 'Vejle Stadium',
    'Hjorring': 'Hjorring Stadium'
}
...
if all_teams_selected == 'Include all available teams':
    row13_spacer1, row13_1, row13_spacer2, row13_2, row13_spacer3, row13_3, row13_spacer4, row13_4, row13_spacer4  = st.columns((.2, 1.6, .2, 1.6, .3, 1.6, .2, 1.6, .2))
    with row13_1:
    ...
    with row14_1:
        return_game_id_value_team = find_match_game_id(show_me_hi_lo,show_me_aspect,show_me_what,show_me_city.replace(" Stadium",""))
