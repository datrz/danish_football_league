...
color_dict = {'AGF': '#ffffff', 'AaB':'#ffffff', 'Brondby':'#ffffff', 'Esbjerg':'#ffffff', 'FC Helsingor':'#ffffff', 'Hobro':'#ffffff', 'Horsens':'#ffffff', 'Kobenhavn':'#ffffff', 'Lyngby':'#ffffff', 'Midtjylland':'#ffffff', 'Nordsjaelland':'#ffffff', 'OB':'#ffffff', 'Randers':'#ffffff', 'Silkeborg':'#ffffff', 'Sonderjyske':'#ffffff', 'Vejle':'#ffffff', 'Vendsyssel':'#ffffff', 'Vestsjaelland':'#ffffff', 'Viborg':'#ffffff'}
