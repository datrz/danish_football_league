...
label_attr_dict = {"Goals":"goals","Halftime Goals":"ht_goals","Shots on Goal":"shots_on_goal", "Ball Possession":"possession", "Fouls Received":"got_fouled", "Yellow cards received":"yellow", "Corners":"corners"}
label_attr_dict_teams = {"Goals Scored":"goals","Goals Received":"goals_received","Halftime Goals Scored":"ht_goals","Halftime Goals Received":"halftime_goals_received","Shots on opposing Goal":"shots_on_goal","Shots on own Goal":"shots_on_goal_received", "Ball Possession":"possession", "Fouls Committed":"fouls", "Fouls Received":"got_fouled", "yellow":"yellow", "Corners":"corners"}
label_attr_dict_correlation = {"Goals":"delta_goals", "Halftime Goals":"delta_ht_goals","Shots on Goal":"delta_shots_on_goal","Possession":"delta_possession","Fouls":"delta_fouls","Yellow cards received":"delta_yellow","Corners":"delta_corners"}
label_fact_dict = {"goals scored":'goals',"halftime goals scored":'ht_goals',"shots on the goal":'shots_on_goal',"possession ratio":'possession',"fouls":'fouls',"yellow":'yellow',"corners":'corners'}
...
def stack_home_away_dataframe(df_data):
    ...
    delta_names = ['goals','ht_goals','shots_on_goal','possession','fouls','yellow','corners']
    ...
    column_names = ['possession','yellow','corners','delta_goals','delta_ht_goals','delta_shots_on_goal','delta_possession','delta_fouls','delta_yellow','delta_corners']
    ...
    column_names_new = ['game_id','season','matchday','location','team','goals','goals_received','ht_goals','ht_goals_received','shots_on_goal','shots_on_goal_received','fouls','got_fouled','possession','yellow','corners','delta_goals','delta_ht_goals','delta_shots_on_goal','delta_possession','delta_fouls','delta_yellow','delta_corners']
    ...
    df_total_sorted = df_total[['game_id','season','matchday','location','team','goals','goals_received','delta_goals','ht_goals','ht_goals_received','delta_ht_goals','shots_on_goal','shots_on_goal_received','delta_shots_on_goal','possession','delta_possession','fouls','got_fouled','delta_fouls','yellow','delta_yellow','corners','delta_corners']]
