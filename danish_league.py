...
if all_teams_selected == 'Include all available teams':
    ...
    with row18_1:
        ...
        st.markdown(f'🇩🇰 **Match {return_game_id_value_team[0]}** was played at **{stadium_name}, {city}, {reg}** and **{attendance1} fans** watched the game on the stadium')
