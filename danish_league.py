...
label_attr_dict = {"Goals":"goals","Halftime Goals":"ht_goals","Shots on Goal":"shots_on_goal", "Ball Possession":"possession", "Fouls Committed":"fouls", "Yellow cards received":"yellow", "Red cards received":"red", "Points received":"points", "Corners":"corners"}
...
label_attr_dict_correlation = {"Goals":"delta_goals", "Halftime Goals":"delta_ht_goals","Shots on Goal":"delta_shots_on_goal","Possession":"delta_possession","Fouls":"delta_fouls","Yellow cards received":"delta_yellow","Red cards received":"delta_red", "Points received":"delta_points","Corners":"delta_corners"}
label_fact_dict = {"goals scored":'goals',"halftime goals scored":'ht_goals',"shots on the goal":'shots_on_goal',"possession ratio":'possession',"fouls":'fouls',"yellow cards received":'yellow',"red cards received":'red',"points received":"points","corners":'corners'}
...
def stack_home_away_dataframe(df_data):
    ...
    column_names = ['possession','yellow','red','points','corners','delta_goals','delta_ht_goals','delta_shots_on_goal','delta_possession','delta_fouls','delta_yellow','delta_red','delta_points','delta_corners']
    ...
    column_names_new = ['game_id','season','matchday','location','team','goals','goals_received','ht_goals','ht_goals_received','shots_on_goal','shots_on_goal_received','fouls','got_fouled','possession','yellow','red','points','corners','delta_goals','delta_ht_goals','delta_shots_on_goal','delta_possession','delta_fouls','delta_yellow','delta_red','delta_points','delta_corners']
